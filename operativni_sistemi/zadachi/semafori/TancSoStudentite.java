...
public class TancSoStudentite {
	...
	static Semaphore mSob = null;
	static Semaphore zSob = null;
	static Semaphore mSpremen = null;
	static Semaphore zSpremna = null;
	static Semaphore odiTancuvaj = null;
    

    public void init() {
        //TODO: da se implementira
        mSob = new Semaphore(10);
        zSob = new Semaphore(10);
        mSpremen = new Semaphore(0);
        zSpremna = new Semaphore(0);
        odiTancuvaj = new Semaphore(3);
    }
